...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  9 12:36:57 2025
...
class Economy:
    ...
    def effective_real_interest_rate(self) -> float:
        ...
        weights /= sum(weights)
       # print(np.dot(weights, self.real_interest_rates[-10:]))
    ...
    def compute_gap_effect(self) -> float:
        ...
        gap = unemployment_rate - natural_rate
        ...
        if gap >= 0:
            ...
            # Using formula: (0.5*n/u + 0.4) * (-gap) where n is natural_rate
    ...
    def simulate_quarter(self) -> Dict[str, any]:
        ...
        self.indicators.unemployment_rate = max(1, new_unemployment)  # Minimum 2% unemployment
